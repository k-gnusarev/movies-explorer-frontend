      ...
      <div className='about-me__description'>
        <div className='about-me__text-section'>
          ...
          <p className='about-me__brief'>Я родился и живу в Саратове, закончил институт электронной техники и машиностроения СГТУ.
            У меня есть кошка. Последние 2,5 года работал переводчиком в Гватемале, параллельно
            изучал веб-разработку. Сейчас работаю фронтенд-разработчиком в Grid Dynamics. В
            свободное время выезжаю на велозаезды, а также посещаю различные музыкальные
            мероприятия, от симфонических концертов до подвальных техносетов.
          </p>
